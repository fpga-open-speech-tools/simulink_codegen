...
class MemoryMappedSlaveNode(MemoryMappedNode):
    ...
    """
    def __init__(self, name, base_addr, span, index=None, parent=None,
        ...
        compatible : str, optional
            Describes compatible drivers with device tree node, by default None
        """
        super().__init__('', base_addr, span, label=None, parent=parent, children=children, compatible=compatible)
        self.index = index
