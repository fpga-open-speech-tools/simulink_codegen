...
%% move the code into main model directory
% NOTE: Matlab gives an error when trying to move a directory if that 
%       directory already exists at the destination. To get around this, we
%       use copyfile instead of movefile
% TODO: remove unnecessary files that get copied
copyfile(['hdlsrc' filesep mp.model_abbreviation filesep '*'], mp.model_path, 'f')
rmdir('hdlsrc', 's')
