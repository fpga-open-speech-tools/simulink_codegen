...
function vgenQuartus(infile, outfile, additionalFilesetAbsDir)

% call the python file that autogens the tcl script
try
    disp("Quartus generation starting")
    disp(['Follow status in log files generated in ' additionalFilesetAbsDir])
    py.autogen_quartus.main(infile, outfile, additionalFilesetAbsDir)
catch e
    disp(getReport(e))
end
